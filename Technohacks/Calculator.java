...
public class Calculator implements ActionListener{
	...
	Font myFont = new Font("calibri",Font.BOLD,45);
	...
	Calculator(){
		...
		textfield.setBounds(50, 25, 470, 60);
...
delButton.setBackground(Color.orange);
		...
		negButton.setBounds(50,430,110,70);
		delButton.setBounds(150,430,110,70);
		clrButton.setBounds(250,430,110,70);
